        ...
        return (
          <div className="fade-up">
            ...
            <div style={{background:th.statBg,borderRadius:16,padding:24,boxShadow:"0 2px 14px rgba(0,0,0,0.1)",maxWidth:700}}>
              ...
              {/* Submit */}
              <button className="submit-btn" onClick={()=>initiatePayment("aadhar_manual","Aadhar Manual Print - ₹10",()=>showToast("✅ Request submit ho gayi! 24 ghante mein process hoga."))} style={{maxWidth:240,background:"linear-gradient(135deg,#f59e0b,#d97706)"}}>
                💳 Pay ₹10 & Submit
              </button>
            </div>
          </div>
      ...
      if (activeSubMenu.id==="nios_form") return (
        <div className="fade-up">
          ...
          <div style={{background:th.statBg,borderRadius:16,padding:24,maxWidth:600}}>
            ...
            <button className="submit-btn" style={{maxWidth:240,background:"linear-gradient(135deg,#f59e0b,#d97706)"}} onClick={()=>initiatePayment("nios_form","NIOS Certificate - ₹20",downloadNiosPDF)}>💳 Pay ₹20 & Download PDF</button>
          </div>
        </div>
      );
        ...
        <div className="fade-up">
          ...
          <div style={{maxWidth:400,margin:"0 auto"}}>
            <div style={{background:th.statBg,borderRadius:20,padding:28,boxShadow:"0 4px 24px rgba(0,0,0,0.12)",textAlign:"center"}}>
              ...
              <div style={{margin:"14px 0",color:th.subtext,fontSize:12,fontWeight:700,textAlign:"center"}}>— YA CARD/UPI APP SE PAY KARO —</div>
